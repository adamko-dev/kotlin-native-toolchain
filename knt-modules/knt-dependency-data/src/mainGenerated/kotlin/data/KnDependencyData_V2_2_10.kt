...
@Suppress("ClassName")
sealed class KnDependencyData_V2_2_10: KnDependencyDataSpec() {

  override val version: KnpVersion = KnpVersion.V2_2_10

  @Suppress("ClassName")
  sealed class Linux_X86_64: KnDependencyData_V2_2_10() {
  ...
  @Suppress("ClassName")
  sealed class MacOs_AArch64: KnDependencyData_V2_2_10() {
    ...
    object LinuxX64: MacOs_AArch64() {
      ...
      override val dependencies: Set<KnpDependency> =
        setOf(
          KnpDependency("kotlin.native:x86_64-unknown-linux-gnu-gcc-8.3.0-glibc-2.19-kernel-4.9:2@tar.gz"),
          KnpDependency("kotlin.native.resources.llvm.19-aarch64-macos:llvm-19-aarch64-macos-essentials:75@tar.gz"),
  ...
  @Suppress("ClassName")
  sealed class MacOs_X86_64: KnDependencyData_V2_2_10() {
    ...
    object LinuxX64: MacOs_X86_64() {
      ...
      override val dependencies: Set<KnpDependency> =
        setOf(
          KnpDependency("kotlin.native:x86_64-unknown-linux-gnu-gcc-8.3.0-glibc-2.19-kernel-4.9:2@tar.gz"),
          KnpDependency("kotlin.native.resources.llvm.19-x86_64-macos:llvm-19-x86_64-macos-essentials:72@tar.gz"),
  ...
  @Suppress("ClassName")
  sealed class Windows_X86_64: KnDependencyData_V2_2_10() {
    ...
    object LinuxX64: Windows_X86_64() {
      ...
      override val dependencies: Set<KnpDependency> =
        setOf(
          ...
          KnpDependency("kotlin.native.resources.llvm.19-x86_64-windows:llvm-19-x86_64-windows-essentials:135@zip"),
