...
@Suppress("ClassName")
sealed class KnDependencyData_V2_1_21: KnDependencyDataSpec() {
  ...
  sealed class MacOs_AArch64: KnDependencyData_V2_1_21() {
    ...
    object LinuxX64: MacOs_AArch64() {
      ...
      override val dependencies: Set<KnpDependency> =
        setOf(
          KnpDependency("kotlin.native:x86_64-unknown-linux-gnu-gcc-8.3.0-glibc-2.19-kernel-4.9:2@tar.gz"),
          KnpDependency("kotlin.native.resources.llvm:16.0.0-aarch64-macos:65@tar.gz", "llvm-16.0.0-aarch64-macos-essentials"),
  ...
  sealed class MacOs_X86_64: KnDependencyData_V2_1_21() {
    ...
    object LinuxX64: MacOs_X86_64() {
      ...
      override val dependencies: Set<KnpDependency> =
        setOf(
          KnpDependency("kotlin.native:x86_64-unknown-linux-gnu-gcc-8.3.0-glibc-2.19-kernel-4.9:2@tar.gz"),
          KnpDependency("kotlin.native.resources.llvm:16.0.0-x86_64-macos:56@tar.gz", "llvm-16.0.0-x86_64-macos-essentials"),
