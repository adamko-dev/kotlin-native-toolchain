...
@Suppress("ClassName")
sealed class KnDependencyData_V2_0_21: KnDependencyDataSpec() {

  override val version: KnpVersion = KnpVersion.V2_0_21

  sealed class Linux_X86_64: KnDependencyData_V2_0_21() {
  ...
  sealed class MacOs_AArch64: KnDependencyData_V2_0_21() {
    ...
    object LinuxX64: MacOs_AArch64() {
      ...
      override val dependencies: Set<KnpDependency> =
        setOf(
          KnpDependency("kotlin.native:x86_64-unknown-linux-gnu-gcc-8.3.0-glibc-2.19-kernel-4.9:2@tar.gz"),
          KnpDependency("kotlin.native.resources.llvm:11.1.0-aarch64-macos:60@tar.gz", "llvm-11.1.0-aarch64-macos-essentials"),
  ...
  sealed class MacOs_X86_64: KnDependencyData_V2_0_21() {
    ...
    object LinuxX64: MacOs_X86_64() {
      ...
      override val dependencies: Set<KnpDependency> =
        setOf(
          KnpDependency("kotlin.native:x86_64-unknown-linux-gnu-gcc-8.3.0-glibc-2.19-kernel-4.9:2@tar.gz"),
          KnpDependency("kotlin.native.resources.llvm:11.1.0-x86_64-macos:47@tar.gz", "llvm-11.1.0-x86_64-macos-essentials"),
  ...
  sealed class Windows_X86_64: KnDependencyData_V2_0_21() {
